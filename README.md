...
# TODO: update deployed_address.txt
# TODO: create design_pattern_decisions.md
# TODO: create avoiding_common_attacks.md
# TODO: update contract to mock updated NDVI data OR get heroku working to actually update the NDVI data
# TODO: update unit tests for new contract
# TODO: before submissions - check all contract addresses are conistent, including in conftest
# TODO: Remove README from .gitignore!
...
4) Open app in web browser, add accounts to MetaMask
   (alternatively run from localhost by openign a new console, navigating to ./client/src and `npm run start`)
...
8)  click "documentation" in upper left corner for more information
...
4) If the initial test fails, it is likely because there is some residual DAI sitting in the contract from previous interactions. If this is the case it can easily be fixed by callign the "escapeHatch()" function in the contract as follows:
...
This will reset the contract balance and the tests should now pass.